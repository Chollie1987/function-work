...
//for problem 3 remember that I only want the 0 index to do the math.
/////////////////////////////////////
/* Problem 3
...
function multiplyArray(multArr) { 
    let theMultArr = multiply(multArr[0], multArr[1]);
    let theMultArrTwo = multiply(theMultArr[0], multArr[2]);
    //let eslint-disable-line
    return[theMultArrTwo[0], `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${theMultArrTwo[0]}.`];
}
